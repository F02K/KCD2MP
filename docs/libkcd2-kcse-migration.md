...
| UI boundary | Copied POD snapshots and commands, compatibility-gated by the shared KCD2MP version (`0.1.0`) | ABI size/project-version tests; no engine pointer crosses the boundary |
