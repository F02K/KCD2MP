...
| Entity isolation | Exact eight-slot `IEntitySystemSink`, reversible state records, active/hidden/AI/physics control | Spawn/remove/reuse tests and audited sink targets |
