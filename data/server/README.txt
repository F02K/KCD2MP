...
1. On a Windows PC where Kingdom Come: Deliverance II is installed, run
   KCD2MPGameDataGenerator.exe once.
...
4. Run start_server.bat. On first launch it creates server.toml from
   server.toml.example automatically. Edit server.toml as needed.

Run KCD2MPGameDataGenerator.exe again after a supported game update or after
